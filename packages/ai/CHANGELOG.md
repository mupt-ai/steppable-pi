...
- Added first-class `streamSimple()` response format support across provider adapters that support native structured output fields.
- Added first-class `streamSimple()` frequency penalty support across provider adapters that support native frequency penalty fields.
