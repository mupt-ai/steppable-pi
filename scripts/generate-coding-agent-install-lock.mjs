...
const internalPackagePrefix = "@mupt-ai/pi-";
const upstreamTuiPackageName = "@earendil-works/pi-tui";
...
function isInternalPackage(name) {
	return name.startsWith(internalPackagePrefix) || name === upstreamTuiPackageName;
}
